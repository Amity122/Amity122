...
class Students():
    def __init__(self, id=None, first_name=None, course=None, last_name = None, gender=None, year_lvl=None, college=None, profile_pic=None):
        self.id = id
    ...
    def add(self): 
        cursor = mysql.connection.cursor()
        sql = f"INSERT INTO students(id, first_name, course, college, last_name, gender, year_lvl, profile_pic) VALUES('{self.id}', '{self.first_name}', '{self.course}','{self.college}', '{self.last_name}', '{self.gender}', '{self.year_lvl}', '{self.profile_pic}')"
        cursor.execute(sql)
    ...
    @classmethod
    def update_student(cls, target_student, new_id=None, new_first_name=None, new_course=None, new_college=None, new_last_name=None, new_gender=None, new_year_lvl=None, new_profile_pic=None):
        cursor = mysql.connection.cursor()
        if new_id:
        ...
        if new_profile_pic:
            sql = f"UPDATE students SET profile_pic = '{new_profile_pic}' WHERE id ='{target_student}'"
        cursor.execute(sql)
